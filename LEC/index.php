...
$works = [
    [
        'prof' => 'КОТ военный',
        'dateStart' => "Февраль 2021",
        'dateEnd' => "Текущее время",
        'descript' => "Кот боевой, а что остается в текущей ситуации."
    ],
    [
        'prof' => 'КОТ изолированный',
        'dateStart' => "Март 2020",
        'dateEnd' => "Февраль 2021",
        'descript' => "Кот изолированный, а что оставолось в той ситуации."
    ],
    [
        'prof' => 'КОТ домашний',
        'dateStart' => "Январь 2010",
        'dateEnd' => "Март 2020",
        'descript' => "Кот диванный, работа по специальности."
    ],
];
$lang = [
    [
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-third">
        <div class="w3-white w3-text-grey w3-card-4">
          ...
          <div class="w3-container">
            ...
            $persent = $skills[$i]['percent'];
            ?>
            <p><?=$skills[$i]['name']; ?></p>
            <div class="w3-light-grey w3-round-xlarge w3-small">
              <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?=$persent;?>%"><?=$persent;?>%</div>
            </div>
            <?php endfor;?>
            <br>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?=$works[$i]['prof']; ?></b></h5>
